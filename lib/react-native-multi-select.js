      ...
      >
        {selector ? (
          <View style={styles.selectorView(fixedHeight)}>
            <View style={[styles.inputGroup, {backgroundColor: '#1e212a'}]}>
              <Icon
                name="magnify"
                size={20}
          ...
          <View>
            <View style={[styles.dropdownView]}>
              <View
                style={[
                  styles.subSection,
                  { paddingTop: 10, paddingBottom: 10, paddingLeft: 7, paddingRight: 0, backgroundColor: 'transparent' }
                ]}
              >
                      ...
                      style={[
                        {
                          flex: 1,
                          fontSize: 18,
                          color: this.state.selected ? 'white' : '#616367'
                        },
                        altFontFamily
